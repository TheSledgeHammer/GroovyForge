 ...
 *
 * Modified by TheSledgeHammer(2019) for using the Apache Groovy instead of Java
 */
...
//Extends ModContainer, thus seperate from FMLModContainer & FMLJavaModLoadingContext.
//Interoperability is unknown.. when using the javafml with this instance of groovyfml
class FMLGroovyModContainerExperimental extends ModContainer {
    ...
    FMLGroovyModContainerExperimental(IModInfo info, String className, ClassLoader modClassLoader, ModFileScanData modFileScanResults) {
        super(info);
        ...
        final FMLGroovyModLoadingContextExperimental contextExtension = new FMLGroovyModLoadingContextExperimental(this);
